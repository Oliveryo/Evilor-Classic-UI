...
V = L == "deDE" and { -- 157/175 (89%)
	...
	"Dämonen", "Ausgeschaltet", z, z, "Doppelklick eine Aktion, um sie dem Ring hinzuzufügen.", "Mit Doppelklick oder durch Ziehen auf die Abschnittsliste werden die Aktionen dem Ring hinzugefügt.", "In andere Ringe standardmäßig einbetten", z, "Leerer Ring", "Ausgewählten Abschnitt vergrößern",
	z, "Beispiel: %s.", z, "Wildheit", "Wächter", z, "Versteckte Ringe", "Haltungsleiste verstecken", "Diesen Ring verstecken", "Symbol:",
	"Der Abschnitt wird versteckt, wenn diese Makro-Bedingung als %shide|r ausgewertet wird oder keine ihrer Klauseln gelten.", "Schnappschuss Importieren", "Klick auf %s oben, um Schnappschüsse zu importieren.", "Inaktive Ringe", "Nach Benutzung offen lassen", "Ringe in den Vordergrund holen", "Stelle diesen Ring zur Verfügung für:", "Minikartenverfolgung", z, "Ringe nach unten bewegen",
	"Ringe nach rechts bewegen", z, "Verschachtelte Ringe", "Neuer Ring...", "Name des neuen Profils:", "Name des neuen Rings:", "Keine %s-Spezialisierungen", "Nicht belegt", z, "OPie-Ring",
	...
	"Profile werden automatisch aktiviert, wenn man zwischen erster und zweiter Spezialisierung wechselt.", "Profile enthalten Einstellungen und Tastaturbelegung der Ringe.", "Questgegenstände", "Schnellwahl in der Ringmitte", z, z, z, "Standard wiederherstellen", "Standardoptionen wiederherstellen", z,
	...
	"Zeige diesen Abschnitt für:", "Tooltips zeigen", z, "Abschnitt", "Abschnitt #%d", "Abschnitt-Tastenbelegungen", "Schnappschuss:", "Spezialisierungen und Reise", "Haltungen", "Speichert eine Momentaufnahme dieses Ringes, um ihn mit anderen Spielern zu teilen.",
	...
	"Verstanden. Trotzdem bearbeiten.", "Änderungen rückgängig machen", "Standardbelegungen nutzen", z, "Nützlichkeit", "Sichtbarkeitsbedingung:", "Hexenmeister - Kampf", "Hexenmeister - Allgemein", "Weltmarkierungen", "World of Warcraft könnte die Einstellungen von OPie aufgrund unzureichenden Speichers nicht laden. Versucht, einige Addons zu deaktivieren.\n\nAlle jetzt getätigten Änderungen werden nicht gespeichert.",
...
or L == "koKR" and { -- 163/175 (93%)
	...
	"악마", "사용 안 함", z, z, "더블 클릭하여 행동을 고리에 추가합니다.", "아래 행동을 조각 목록으로 더블 클릭하거나 드래그해서 고리에 추가합니다.", "기본으로 다른 고리에 삽입", z, "빈 고리", "선택한 조각 확대",
	"장비 구성:", "예: %s.", "추가 차원문", "야성", "경비병", z, "숨은 고리", "태세 바 숨김", "이 고리를 숨김", "아이콘:",
	"이 매크로가 %s숨김|r 조건으로 설정되거나 해당 절이 하나도 적용되지 않으면, 이 조각은 숨겨집니다.", "스냅샷 가져오기", "위의 %s를 클릭하여 스냅샷을 불러옵니다.", "비활성 고리", "사용 후 열어 두기", "고리 최상위로", "이 고리를 사용할 대상:", "미니맵 추적", z, "고리를 아래로 이동",
	"고리를 오른쪽으로 이동", z, "중첩된 고리", "새 고리...", "새 프로필 이름:", "새 고리 이름:", "%s 전문화가 아닐 때", "지정 안 됨", z, "OPie 고리",
	...
	"주와 보조 전문화를 서로 교체할 때 프로필을 자동으로 활성화합니다.", "프로필은 옵션과 고리 단축키를 저장합니다.", "퀘스트 아이템", "고리 중심에서 빠른 행동", z, z, z, "기본값 복원", "기본 설정 복원", "고리",
	...
	"이 조각을 보여줄 대상:", "툴팁 표시", z, "조각", "조각 #%d", "조각 단축키", "스냅샷:", "전문화 및 이동", "태세", "이 고리의 스냅샷을 찍어 다른 사람과 공유합니다.",
	...
	"이해하지만, 어쨌든 수정합니다.", "변경 사항 취소", "기본 고리 단축키 사용", z, "유틸기", "조각 보임 조건:", "흑마법사 전투", "흑마법사 일반", "위치 표시기", "월드오브 워 크래프트가 메모리 부족으로 OPie의 저장된 변수들을 불러올 수 없습니다. 다른 애드온을 비활성화하고 다시 시도하십시오.",
...
or L == "ruRU" and { -- 102/175 (58%)
	z, "(по умолчанию)", z, "Действие", "Активация левой кнопкой", "Создать кольцо", "Добавить новый фрагмент", "Все персонажи   %s", "Все специализаций  %s", "Все персонажи",
	"Разрешить быстрое применение", z, "Анимация", "Внешний вид", "Аспекты", "Нажмите, чтобы изменить иконку", "Поведение", "Назначение", z, "Назначение клавиши:",
	...
	z, "Альтернативный значок", z, z, z, "По умолчанию", "По умолчанию для всех колец", "Удалить текущий профиль", "Удалить кольцо", "Удалить фрагмент",
	...
	"Вы можете использовать расширенные макро условия; см. |cff33DDFF%s|r.", "Вы должны включить опцию %s в настройках OPie.", "Скорость появления/сворачивания", z, z,
}
or L == "zhCN" and { -- 147/175 (84%)
	"(%.1f 秒)", "(默认)", z, "技能", "左键点击使用", "增加环", "添加一个新功能", "所有%s角色", "所有为 %s 的角色", "全部角色",
	...
	"右移环", z, "嵌套环", "创建新环", "新配置名称:", "新环名称:", "没有 %s 角色", "未绑定", z, "OPie环",
...
T.L = V and {
	["(%.1f sec)"]=V[1],
	["(default)"]=V[2],
	["(enter an icon name or path here)"]=V[3],
	["Action"]=V[4],
	...
	["Alt+Left Click on a button to set a conditional binding, indicated by %s."]=V[12],
	["Animation"]=V[13],
	["Appearance"]=V[14],
	["Aspects"]=V[15],
	["Based on slice action"]=V[16],
	["Behavior"]=V[17],
	["Binding"]=V[18],
	["Binding conflict"]=V[19],
	["Binding:"]=V[20],
	["Blessings"]=V[21],
	["Cancel"]=V[22],
	["Caption:"]=V[23],
	["Center caption"]=V[24],
	["Center icon"]=V[25],
	["Center rings at mouse"]=V[26],
	["Changes will not be saved"]=V[27],
	["Choose a binding for this ring, or enable the %s option in OPie options."]=V[28],
	["Color:"]=V[29],
	["Combat"]=V[30],
	["Conditional Bindings"]=V[31],
	["Conditional Visibility"]=V[32],
	["Conflicts with: %s"]=V[33],
	["Create Profile"]=V[34],
	["Create a New Profile"]=V[35],
	["Create a New Ring"]=V[36],
	["Create a new profile"]=V[37],
	["Custom Rings"]=V[38],
	["Customize OPie by modifying existing rings, or creating your own."]=V[39],
	["Customize OPie key bindings below. |cffa0a0a0Gray|r and |cffFA2800red|r bindings conflict with others and are not currently active."]=V[40],
	["Customize OPie's appearance and behavior. Right clicking a checkbox restores it to its default state."]=V[41],
	["Customized icon"]=V[42],
	["DataBroker"]=V[43],
	["Default binding disabled"]=V[44],
	["Default ring binding:"]=V[45],
	["Defaults"]=V[46],
	["Defaults for all rings"]=V[47],
	["Delete current profile"]=V[48],
	["Delete ring"]=V[49],
	["Delete slice"]=V[50],
	["Demons"]=V[51],
	["Disabled"]=V[52],
	["Display as nested ring"]=V[53],
	["Display as:"]=V[54],
	["Double click an action to add it to the ring."]=V[55],
	["Double click or drag the actions below onto the slice list to add them to the ring."]=V[56],
	["Embed into other rings by default"]=V[57],
	["Embed slices in this ring"]=V[58],
	["Empty ring"]=V[59],
	["Enlarge selected slice"]=V[60],
	["Equip set:"]=V[61],
	["Example: %s."]=V[62],
	["Extra Portals"]=V[63],
	["Feral"]=V[64],
	...
	["Hearthstones"]=V[66],
	["Hidden rings"]=V[67],
	["Hide stance bar"]=V[68],
	["Hide this ring"]=V[69],
	["Icon:"]=V[70],
	["If this macro conditional evaluates to %shide|r, or if none of its clauses apply, this slice will be hidden."]=V[71],
	["Import snapshot"]=V[72],
	["Import snapshots by clicking %s above."]=V[73],
	["Inactive rings"]=V[74],
	["Leave open after use"]=V[75],
	["Make rings top-most"]=V[76],
	["Make this ring available to:"]=V[77],
	["Minimap Tracking"]=V[78],
	["More active rings"]=V[79],
	["Move rings down"]=V[80],
	["Move rings right"]=V[81],
	["Nested ring: %s"]=V[82],
	["Nested rings"]=V[83],
	["New Ring..."]=V[84],
	["New profile name:"]=V[85],
	["New ring name:"]=V[86],
	["No %s specializations"]=V[87],
	["Not bound"]=V[88],
	["Not customized"]=V[89],
	["OPie Ring"]=V[90],
	["OPie ring: %s"]=V[91],
	["OPie rings"]=V[92],
	["Only %s"]=V[93],
	["Open nested ring"]=V[94],
	["Options:"]=V[95],
	["Other Bindings"]=V[96],
	["Outward spiral on hide"]=V[97],
	["Paladin Buffs"]=V[98],
	["Per-slice bindings"]=V[99],
	["Per-slice icons"]=V[100],
	["Pets"]=V[101],
	["Pointer rotation speed"]=V[102],
	["Polymorphs"]=V[103],
	["Portals and Teleports"]=V[104],
	["Pre-select a quick action slice"]=V[105],
	["Presences"]=V[106],
	["Press ENTER to save."]=V[107],
	["Press |cffffffffEnter|r to search"]=V[108],
	["Primary default binding button"]=V[109],
	["Profile"]=V[110],
	["Profiles activate automatically when you switch character specializations."]=V[111],
	["Profiles save options and ring bindings."]=V[112],
	["Quest Items"]=V[113],
	["Quick action at ring center"]=V[114],
	["Randomize on display"]=V[115],
	["Remember last rotation"]=V[116],
	["Reset on display"]=V[117],
	["Restore default"]=V[118],
	["Restore default settings"]=V[119],
	["Ring"]=V[120],
	["Ring Bindings"]=V[121],
	["Ring name:"]=V[122],
	["Ring scale"]=V[123],
	["Ring: %s"]=V[124],
	["Rotation period"]=V[125],
	["Rotation:"]=V[126],
	["Scale animation speed"]=V[127],
	["Scroll nested ring (down)"]=V[128],
	["Scroll nested ring (up)"]=V[129],
	["Scroll wheel sensitivity"]=V[130],
	["Seals"]=V[131],
	["Search"]=V[132],
	["Secondary default binding button"]=V[133],
	["Select a ring to modify"]=V[134],
	["Selected slice (keep ring open)"]=V[135],
	["Shapeshifts"]=V[136],
	["Share ring"]=V[137],
	["Shots"]=V[138],
	["Show cooldown numbers"]=V[139],
	["Show recharge numbers"]=V[140],
	["Show this slice for:"]=V[141],
	["Show tooltips"]=V[142],
	["Shuffle after use"]=V[143],
	["Slice"]=V[144],
	["Slice #%d"]=V[145],
	["Slice Bindings"]=V[146],
	["Snapshot:"]=V[147],
	["Specializations and Travel"]=V[148],
	["Stances"]=V[149],
	["Take a snapshot of this ring to share it with others."]=V[150],
	["Target Markers"]=V[151],
	["The binding will update to reflect the value of this macro conditional."]=V[152],
	["The following macro command opens this ring:"]=V[153],
	["This binding is currently used by another addon."]=V[154],
	["This binding is not currently active because it conflicts with another."]=V[155],
	["To enable the default binding for this ring, check this box or change the binding."]=V[156],
	["Trade Skills"]=V[157],
	["Traps"]=V[158],
	["Trinkets"]=V[159],
	["Unbind"]=V[160],
	["Understood; edit anyway"]=V[161],
	["Undo changes"]=V[162],
	["Use default ring bindings"]=V[163],
	["Use first slice when opened"]=V[164],
	["Utility"]=V[165],
	["Visibility conditional:"]=V[166],
	["Warlock Combat"]=V[167],
	["Warlock General"]=V[168],
	["World Markers"]=V[169],
	["World of Warcraft could not load OPie's saved variables due to a lack of memory. Try disabling other addons.\n\nAny changes you make now will not be saved."]=V[170],
	["You may use extended macro conditionals; see |cff33DDFF%s|r for details."]=V[171],
	["You must enable the %s option for this ring in OPie options to use quick actions."]=V[172],
	["Zoom-in/out time"]=V[173],
	["|cffffffffCtrl+Enter|r to search within current results"]=V[174],
	["|cffffffffEscape|r to cancel"]=V[175],
